...
MaxRectsBinPack = maxrectsbinpack.MaxRectsBinPack
...
class MaxRectsVisualizer(ui.View):
    ...
    def initMaxRects(self, width, height, freeChoiceHeuristic = maxrectsbinpack.FreeRectChoiceHeuristic.RectBestShortSideFit):
        self.binRectPacker = MaxRectsBinPack()
    ...
    def addSourceRect(self, sourceSize = None, sourceColor = None):
        ...
        packedBound = self.binRectPacker.insert(sourceSize.width, sourceSize.height, self.freeChoiceHeuristic)
    ...
    def onRender(self, renderer):
        ...
        #####################################################################
        # Debug FreeRects
        # for rectItem in self.maxRectsBinPack._freeRectangles:
        ...
        #####################################################################
        # Debug UsedRects
        # for rectItem in self.maxRectsBinPack._usedRectangles:
        #     renderBound = core.Rect(rectItem)
        #     renderBound.x = adjustFactor.x * rectItem.x
        #     renderBound.y = adjustFactor.y * rectItem.y
        #     renderBound.width = adjustFactor.x * rectItem.width
