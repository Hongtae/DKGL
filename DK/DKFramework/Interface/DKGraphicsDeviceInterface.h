...
namespace DKFramework
{
	...
	public:
		...
		virtual DKObject<DKGpuBuffer> CreateBuffer(size_t, DKGpuStorageMode, DKCpuCacheMode) = 0;
		virtual DKObject<DKTexture> CreateTexture(const DKTextureDescriptor&) = 0;
