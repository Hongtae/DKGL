...
namespace DKFoundation
{
	...
	public:
		...
		struct PendingState
		{
			...
			virtual bool Result() const = 0;	///< wait until done
		...
		bool IsWrokingThread() const;
		DKThread::ThreadId RunningThreadId() const;
		...
		double PendingEventInterval() const;
		...
		static DKObject<DKEventLoop> CurrentEventLoop();
	...
	protected:
		...
		virtual void OnIdle() { WaitNextLoop(); }
