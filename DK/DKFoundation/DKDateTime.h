...
namespace DKFoundation
{
	...
	public:
		...
		int64_t HoursSinceEpoch() const;
		int64_t MinutesSinceEpoch() const;
		int64_t SecondsSinceEpoch() const;
		static long TimezoneOffset();			///< returns second offsets with GMT
		...
		double IntervalSinceEpoch() const;
